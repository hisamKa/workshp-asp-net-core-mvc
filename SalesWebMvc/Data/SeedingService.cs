...
namespace SalesWebMvc.Data
{
    ...
    {
        //Registrar dependencia desse SeedingService com o nosso DBContest(SalesWebMvc)

        private SalesWebMvcContext _context;

        //injeção de dependencias
        public SeedingService(SalesWebMvcContext context)//Qnd um seedingService for criado automaticamente ele vai receber uma instancia do context tbem
        {
            _context = context;
        }

        public void Seed()//REsponsavel por popular minha base de dados
        {
            //Any -> testa se existe algum registro
            if (_context.Department.Any() || //se existe algum dado na minha base de dados vou interromper a operação 
               _context.Seller.Any() ||
            ...
            //Mandar adicionar no BD usando o frameWork
            ...
            //Efetivar alteração, salva e confirma as alterações
